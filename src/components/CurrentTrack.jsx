...
export function CurrentTrack({
  ...
  return (
    <AnimatePresence mode="wait">
      {active && (
        <motion.div
          className="cursor-pointer select-none flex items-center bg-background-deeper/30 rounded-md border border-app-border/30 overflow-hidden pr-2.5 py-1 relative"
          initial="hidden"
          animate="visible"
          exit="hidden"
        ...
        >
          ...
          <motion.div
            className="absolute bottom-0 left-0 h-[3px] bg-background-subtle"
